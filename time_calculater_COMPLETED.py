...
def add_time(time, add_time, day=None):
  ...
  days_tick = int(-(-days_in_hour1 // 1) - 1)
  loop_count =0
...
####### below are my trial and error code scraps used to build ######
